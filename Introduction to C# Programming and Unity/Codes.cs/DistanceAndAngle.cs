    ...
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            while (input[0] != 'q')
            {
                ...
                float distanciaHipotenusa = (float)(Math.Sqrt((deltaX * deltaX) + (deltaY * deltaY)));
                float angleT = (float)(Math.Atan2(deltaY, deltaX) * (180 / Math.PI));
                Console.WriteLine(distanciaHipotenusa + " " + angleT);
